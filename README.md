...
Each exercise lives in its own directory under [`exercises/`](./exercises/). The format varies by exercise — see the README inside each directory for the prompt and any setup instructions.
...
We care less about a polished final result than about how you think:
